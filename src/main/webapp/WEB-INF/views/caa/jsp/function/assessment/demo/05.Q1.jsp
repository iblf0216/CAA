...
<body>
	<div id="container">
		...
		<div class="hide1" id="nextPage">showTest02Process.do?next=demo/07.Q2</div>
	...
	$(document).ready(function() {
		...
		$('body').keydown(function(event) {
			...
			if (event.which == 50 || event.which == 56) { // 數字8 換下一頁
				...
				var href = "showFocus.do?next=" + next;
				href += "&durationTime=" + durationTime;
