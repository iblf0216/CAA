...
<body>
	<div id="container">
		...
		<div class="hide1" id="nextPage">showTest02Process.do?next=test_01/demo/demoPage13</div>
		<div class="text-center">
			<h3>示範2</h3>
		</div>
		<div class="text-center" style="height: 80%; weight: 80%;">
			<img src="resources/images/test01/demo_pic/15.JPG" style="height:90%;">
		</div>
	</div>
